...
# Hub Orion - MEMORY_LOG FORMAT OFFICIEL IAPF
# Format strict : ts_iso | type | title | details | author | source | tags
# Séparateur : TAB (\t)
# 7 colonnes exactes
HUB_MEMORY_LOG_COLUMNS = [
    "ts_iso",      # ISO UTC timestamp
